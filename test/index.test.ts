...
import { IProduct, Product } from '../src/models/products';
    ...
    describe("Product", () => {
      ...
      describe("Get", () => {
        ...
        describe('All', () => {
          ...
          test.todo("should get all(ProductsController)")/*,async done=>{
            const response = {
              send: sinon.spy()
            };
            ...
            const stub=sinon.stub(Product,"find").withArgs({}).resolves([{}]);
